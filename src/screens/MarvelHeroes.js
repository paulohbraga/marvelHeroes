...
const MarvelHeroes = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, flexDirection: 'column', alignItems: 'center', width: '100%', height: '100%', backgroundColor: '#E21320' }}>
      ...
      {visibleSearch ? <View style={{ margin: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', alignContent: 'center', padding: 10 }}>
        <TextInput clearButtonMode="always" style={{ width: '80%', paddingLeft: 15, borderRadius: 45, borderColor: 'black', borderWidth: 1.5, height: 50, fontSize: 18, backgroundColor: '#fff' }} placeholder="Buscar Herói"
          value={textSearch}
